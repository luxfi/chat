...
const navigationMenuTriggerStyle = cva(
  ...
  'text-sm font-medium transition-colors hover:bg-muted text-foreground hover:text-accent ' +
...
>(({ className, children, ...props }, ref) => (
  ...
  >
    {children}{' '}
    <ChevronDown
      className='relative top-[1px] ml-1 h-3 w-3 transition duration-200 group-data-[state=open]:rotate-180 focus:text-accent focus:outline-none disabled:pointer-events-none disabled:opacity-50 '
      aria-hidden='true'
    />
  </NavigationMenuPrimitive.Trigger>
))
