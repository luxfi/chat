...
import { Accordion, AccordionItem, AccordionTrigger, AccordionContent } from '../ui/primitives'
...
const MobileNav: React.FC<{
  ...
  setMenuOpen
    ...
    links.length > 0 ? (
      <div className={cn('flex flex-col h-full z-header', className)}>
        <MobileNavHeader setMenuOpen={setMenuOpen} />
